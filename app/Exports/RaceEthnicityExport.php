...
/**
 * Class RaceEthnicityExport - Export to Excel Spreadsheet
 */
class RaceEthnicityExport implements FromQuery, WithHeadings, WithMapping
{
    use Exportable;
    ...
    public function map($race_ethnicity): array
    {
        return [
