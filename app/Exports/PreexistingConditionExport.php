...
/**
 * Class PreexistingConditionExport - Export to Excel Spreadsheet
 * @package App\Exports
 */
class PreexistingConditionExport implements FromQuery, WithHeadings, WithMapping
{
    use Exportable;
    ...
    public function map($preexisting_condition): array
    {
        return [
