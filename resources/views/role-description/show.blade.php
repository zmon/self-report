    ...
    <div class="row">
        <div class="col-md-12">
            <div class="row mt-4">
                <div class="col-md-4">
                    @if ($can_edit)
                        <a href="/role-description/{{ $role_description->id }}/edit" class="btn btn-primary">Edit Role
                            Description</a>
                    @endif
                </div>
