<template>
    <form @submit.prevent="handleSubmit" class="form-horizontal">
        ...
        <p>
            After saving this form you will be sent to the login screen where
            you can login using your email address and password you created.
        </p>
        <div class="row">
            <div class="col-md-9">
        ...
        <div class="form-group">
            <div class="row mt-4">
                <div class="col-md-6">
                    <button
                        type="submit"
                        v-bind:disabled="changePasswordBtnDisable"
                ...
                <div class="col-md-6 text-md-right mt-2 mt-md-0">
                    <a href="/vc-vendor" class="btn btn-sm btn-default"
                        >Cancel</a
                    >
                </div>
            </div>
