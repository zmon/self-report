    ...
    <div>
        ...
        <div class="grid no-more-tables table-responsive mb-4">
            <table class="table table-striped table-hover mb-0">
                ...
                <tr v-else v-for="row in this.gridData" :key="row.id">
                    ...
                    >
                        <a
                            v-bind:href="'/invite/' + row.id + '/edit'"
                        ...
                        &nbsp; &nbsp;
                        <a
                            v-bind:href="'/invite/' + row.id + '/resend'"
                            v-if="params.CanEdit == '1'"
                            class="grid-action-item"
                        >
                            Resend
        ...
        <div class="grid-bottom row mb-0 align-items-center">
            <div class="col-lg-4 mb-2">
                <a href="/invite/download" class="btn btn-primary mb-2 mr-2"
                >Export to Excel</a
                >
                <a href="/invite/print" class="btn btn-primary mb-2 mr-2"
                >Print PDF</a
                >
            </div>
            <ss-grid-pagination
...
<script>
    ...
    export default {
        ...
        methods: {
            goToNew: function () {
                window.location.href = "/invite/create";
            },
