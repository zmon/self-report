    ...
    <div>
            ...
            <table class="table table-striped table-hover mb-0">
                <thead>
                    <tr>
                        ...
                        <th style="width:10%;" class="text-lg-center">
                            Actions
                        </th>
                    </tr>
                </thead>
        ...
        <div class="grid-bottom row mb-0 align-items-center">
            <div class="col-lg-4 mb-2">
                <a href="/user/download" class="btn btn-primary mb-2 mr-2"
                    >Export to Excel</a
                >
                <a href="/user/print" class="btn btn-primary mb-2 mr-2"
                    >Print PDF</a
                >
            </div>
            <ss-grid-pagination
