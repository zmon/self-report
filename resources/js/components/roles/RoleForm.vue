    ...
    <form @submit.prevent="handleSubmit" class="form-horizontal">
        ...
        <div class="row">
            <div class="col-md-12">
                <std-form-group
                    label="Can Assign"
                    label-for="can_assign"
                    :errors="form_errors.can_assign"
                >
                    <fld-checkbox
                        name="can_assign"
                        v-model="form_data.can_assign"
                    />
                </std-form-group>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <button
                        ...
                        :disabled="processing"
                    >
                        <span v-if="this.form_data.id">Change role</span>
                        <span v-else="this.form_data.id">Add role</span>
                    </button>
                </div>
                <div class="col-md-6 text-md-right mt-2 mt-md-0">
                    <a href="/role" class="btn btn-default">Cancel</a>
                </div>
            </div>
        </div>
    </form>
