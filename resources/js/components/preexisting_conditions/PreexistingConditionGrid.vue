    ...
    <div>
        ...
        <div class="grid-top row mb-0 align-items-center">
            <div class="col-lg-8 mb-2">
                <form class="form-inline mb-0">
                    <a v-if="params.CanAdd" href="#" @click.default="goToNew" class="btn btn-primary mb-3 mb-sm-2 mr-3">Add Preexisting Conditions</a>
                    <search-form-group
                            class="mb-0"
        ...
        <div class="grid no-more-tables table-responsive mb-4">
            <table class="table table-striped table-hover mb-0">
                ...
                <tr v-else v-for="row in this.gridData" :key="row.id">
                                                            <td data-title="Name">
                        <a v-bind:href="'/preexisting-condition/' + row.id"
                        ...
                        <a v-bind:href="'/preexisting-condition/' + row.id + '/edit'"
                           v-if="(params.CanEdit)"
        ...
        <div class="grid-bottom row mb-0 align-items-center">
            <div class="col-lg-4 mb-2">
                <a href="/preexisting-condition/download" class="btn btn-primary mb-2 mr-2">Export to Excel</a>
                <a href="/preexisting-condition/print" class="btn btn-primary mb-2 mr-2">Print PDF</a>
            </div>
...
<script>
    ...
    export default {
        name: 'preexisting-condition-grid',
        ...
        methods: {
            ...
            goToNew: function () {
                window.location.href = '/preexisting-condition/create';
            },
                        ...
                        .then(response => {
                            ...
                            if (error.response) {
                                ...
                                if (error.response.status === 422) {
                                    ...
                                    window.location = '/preexisting-condition';
            ...
            getDataUrl: function (new_page_number) {
                ...
                var url = 'api-preexisting-condition?';
                var queryParams = [];
