<template>
    <form @submit.prevent="handleSubmit" class="form-horizontal">
        ...
        <p>After saving this form you will be sent to the login screen where you can login using your email
            address and password you provided.</p>
        ...
        <div class="row">
            <div class="col-md-9">
                <std-form-group
                    ...
                    :errors="form_errors.current_password"
                >
                    <input
                        type="password"
                        class="form-control"
    ...
    export default {
        ...
        methods: {
            ...
            async updateScore(password, userInputs) {
                ...
                var user_inputs = [];
                user_inputs.push(this.form_data.current_password); // Add in comparison to current password for strength
