            ...
            <div class="row">
                <div class="col-md-6">
                    <button type="submit" class="btn btn-primary" :disabled="processing">
                        <span v-if="this.form_data.id">Change Rax Ethnicity</span>
                        <span v-else="this.form_data.id">Add Rax Ethnicity</span>
                    </button>
                </div>
                <div class="col-md-6 text-md-right mt-2 mt-md-0">
                    <a href="/race-ethnicity" class="btn btn-default">Cancel</a>
                </div>
            </div>
        </div>
    </form>
        ...
        methods: {
            async handleSubmit() {
                ...
                if (this.form_data.id) {
                    url = '/race-ethnicity/' + this.form_data.id;
                    amethod = 'put';
                } else {
                    url = '/race-ethnicity';
                    amethod = 'post';
