<template>
    <form @submit.prevent="handleSubmit" class="form-horizontal">
        ...
        <div class="row">
            <div class="col-md-12">
                <std-form-group label="Public Private Exposure" label-for="public_private_exposure"
                                :errors="form_errors.public_private_exposure">
                    <fld-input
        ...
        <div class="row">
            <div class="col-md-12">
                <std-form-group label="Selfreport Or Other" label-for="selfreport_or_other"
                                :errors="form_errors.selfreport_or_other">
                    <fld-input
        ...
        <div class="row">
            <div class="col-md-12">
                <std-form-group label="Any Other Symptoms" label-for="any_other_symptoms"
                                :errors="form_errors.any_other_symptoms">
                    <fld-input
        ...
        <div class="row">
            <div class="col-md-12">
                <std-form-group label="Symptom Severity" label-for="symptom_severity"
                                :errors="form_errors.symptom_severity">
                    <fld-input
        ...
        <div class="row">
            <div class="col-md-12">
                <std-form-group label="Immunocompromised" label-for="immunocompromised"
                                :errors="form_errors.immunocompromised">
                    <fld-input
        ...
        <div class="row">
            <div class="col-md-12">
                <std-form-group label="Symptom Start Date" label-for="symptom_start_date"
                                :errors="form_errors.symptom_start_date">
                    <fld-input
        ...
        <div class="row">
            <div class="col-md-12">
                <std-form-group label="Followup Contact" label-for="followup_contact"
                                :errors="form_errors.followup_contact">
                    <fld-input
        ...
        <div class="row">
            <div class="col-md-12">
                <std-form-group label="Preferred Contact Method" label-for="preferred_contact_method"
                                :errors="form_errors.preferred_contact_method">
                    <fld-input
        ...
        <div class="row">
            <div class="col-md-12">
                <std-form-group label="Is Voicemail Ok" label-for="is_voicemail_ok"
                                :errors="form_errors.is_voicemail_ok">
                    <fld-input
        ...
        <div class="row">
            <div class="col-md-12">
                <std-form-group label="Crowded Setting" label-for="crowded_setting"
                                :errors="form_errors.crowded_setting">
                    <fld-input
        ...
        <div class="row">
            <div class="col-md-12">
                <std-form-group label="FormVersionNumber" label-for="FormVersionNumber"
                                :errors="form_errors.FormVersionNumber">
                    <fld-input
        ...
        <div class="row">
            <div class="col-md-12">
                <std-form-group label="ExternalRespondentId" label-for="ExternalRespondentId"
                                :errors="form_errors.ExternalRespondentId">
                    <fld-input
        ...
        <div class="row">
            <div class="col-md-12">
                <std-form-group label="SourceElementId" label-for="SourceElementId"
                                :errors="form_errors.SourceElementId">
                    <fld-input
        ...
        <div class="row">
            <div class="col-md-12">
                <std-form-group label="DataConnectionId" label-for="DataConnectionId"
                                :errors="form_errors.DataConnectionId">
                    <fld-input
